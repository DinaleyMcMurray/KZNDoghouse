...
class HomeActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Open drawer when nav icon is tapped
        ...
        navView.setNavigationItemSelectedListener { item ->
            when (item.itemId) {
                ...
                R.id.nav_view_adoption -> startActivity(Intent(this, ViewAdoptionActivity::class.java))
                ...
                R.id.nav_dog_food -> startActivity(Intent(this, DogFoodActivity::class.java))
                ...
                R.id.nav_volunteer_management -> startActivity(Intent(this, VolunteerManagementActivity::class.java)) // ✅ opens volunteer management
                ...
                R.id.nav_admin_login -> startActivity(Intent(this, AdminLoginActivity::class.java))

                // === Extras ===
                R.id.nav_uploads -> { /* TODO: Hook uploads */ }
                R.id.nav_settings -> { /* TODO: Hook settings */ }
            }
        ...
        // Example button navigation (home screen button)
